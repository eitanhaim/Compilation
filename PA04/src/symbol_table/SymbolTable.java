...
public class SymbolTable {
	  ...
	  private Map<IDSymbolKinds, Integer> entryKindsCounter;
	  ...
	  private Map<IDSymbolKinds, Integer> generateKindsCounter() {
		  Map<IDSymbolKinds, Integer> entryKindsCounter = new HashMap<IDSymbolKinds, Integer>();
		  entryKindsCounter.put(IDSymbolKinds.CLASS, 0);
		  entryKindsCounter.put(IDSymbolKinds.FIELD, 0);
		  entryKindsCounter.put(IDSymbolKinds.FORMAL, 0);
		  entryKindsCounter.put(IDSymbolKinds.STATIC_METHOD, 0);
		  entryKindsCounter.put(IDSymbolKinds.VIRTUAL_METHOD, 0);
		  entryKindsCounter.put(IDSymbolKinds.VARIABLE, 0);
